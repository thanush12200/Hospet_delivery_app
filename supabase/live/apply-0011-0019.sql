-- FAA: migrations 0011-0019 in one paste for the Supabase SQL editor.
...
select column_name from information_schema.columns where table_name='products' and column_name='sale_price_paise';
